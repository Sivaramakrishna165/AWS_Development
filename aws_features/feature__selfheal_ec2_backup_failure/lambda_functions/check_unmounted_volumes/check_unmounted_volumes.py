"""
    ...
    In dxcms_sh_bf_sfn_diagnosis state machine(CheckUnmountedVolumes)
    gets executed after TriggerUnmountedVolumeCheck and after WaitFprSSMCommand.
    ...
    In dxcms_sh_bf_sfn_diagnosis 
    On successful check, next state choicestatetostopinstance is called
    On FAILURE, next State CheckUnmountedVolumesError and then NotifyForLambaFunctionFailure.
...
event_win = {"instance_id" : "i-03f2a963369545021", "command_id" : "b955264e-8cb6-44dd-a425-0e791a69385a"}
event_linux = {"instance_id" : "i-0938fa5628083f05d", "command_id" : "3828ccc2-cf85-48b5-a35e-24842b359191"}

if __name__ == "__main__":
    lambda_handler(event_win,"")