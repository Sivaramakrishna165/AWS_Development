...
def lambda_handler(event, context):
    try:
        ...
        secondary_DBSubnetGroupName="Feature-RDSInstanceMysql-Multi-Region-"+str(uuid4())
        secondary_DBSubnetGroupDescription="RDSInstanceMysql-Multi-Region"
        ...
        primary_nested_stack_logical_id="RDSInstanceMysql"
        try:
            ...
            if event["secondary"].lower()=="wait_rds_active":
                ...
                for db in db_instances:
                    ...
                    if db['DBInstanceIdentifier']==secondary_db_identifier.lower() and db['DBInstanceStatus'].lower()=="available":
                        ...
                        title="RDS-Mysql instance {} - Failover".format(db_identifier)
            ...
            if event["primary"].lower()=="wait_rds_active":
                ...
                for db in db_instances:
                    if db['DBInstanceIdentifier']==db_identifier.lower() and db['DBInstanceStatus'].lower()=="available":
                        ...
                        title="RDS-Mysql instance {} - Failback".format(secondary_db_identifier)
