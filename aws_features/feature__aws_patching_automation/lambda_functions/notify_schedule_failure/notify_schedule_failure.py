'''
This lambda script is used to notify the error to user if there is an issue on schedule phase
'''
...
def email_body_content(State,State_Machine_Name,State_Machine_Id,Region,Account_id):
    try:
        ...
        CHARSET = "utf-8"
        SUBJECT = "ERROR AWS " + Account_id + " PE2E Automation | Patch Schedule Creation Failed" 
        ...
        BODY_HTML = """ <html>
            ...
            <body>
            <p style = "font-weight: bold;font-size: 20px;color:red;">PATCH SCHEDULE CREATION FAILED FOR NEXT MONTH</style></p>
            <p>Hi Team,</p>
            <p>Creation of Patch Schedule is FAILED for next month. Please find the details in below.</p>
             """
