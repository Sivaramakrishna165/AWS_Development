...
Reference_CR_No = os.environ['Reference_CR_No'] #'/DXC/PatchingAutomation/Reference_CR_No'

# Snow_url = #"https://api.test.platform.dxc.com/cha1-api/dxc/change/R2/changes"
# company_value :  "0971e120db3122006052fd9eaf9619c9"
# url = "https://csctest.service-now.com/api/sn_chg_rest/change"
...
def read_data_from_config_file(S3_Bucket,S3_directory_name):
    ...
    execute_patch_scan_json_object = jsonObject[Keyname1] 
    patchJobIds_json_object = jsonObject[Keyname2]  
...
def convert_time(patch_start_date,patch_end_date):
    #TagValues,patch_start_date,patch_end_date = read_data_from_config_file(S3_Bucket,S3_directory_name)
...
def lambda_handler(event, context):
    try:
        ...
        secret = get_secret()
        change_requests = {}
        TagValues,patch_start_date,patch_end_date,Tagvalue_with_grp_name,patchJob_ids = read_data_from_config_file(S3_Bucket,S3_directory_name)
        ...
        update_congif_file(S3_Bucket,S3_directory_name,change_requests)
...
event1 = {
  "TagValues": [
    'WIN_TEST-MAY_14_2022_13_30_4HRS',
    'RHEL_TEST-MAY_8_2022_13_30_4HRS'
  ],
  "S3_Bucket": "aws-patching-automation-bucket-second",
  'S3_directory_name': 'MAY_2022/ap-south-1',
