...
def lambda_handler(event, context):
    ...
    try:
        if event[0]['Cause']:
            ...
            output_with_error_cause["Cause"] = Cause
            output_with_error_cause['PatchInstallOn'] = tagValue
            output_with_error_cause["S3_Bucket"] = S3_Bucket
            output_with_error_cause["S3_directory_name"] = S3_directory_name
            output_with_error_cause["Step Function Execution_id"] = Execution
            output_with_error_cause["StateMachine"] = StateMachine_Name
        ...
        return output_with_error_cause
        #print("output_with_error_cause ======> ",output_with_error_cause)
    except:
        output = event[0]
        return output
