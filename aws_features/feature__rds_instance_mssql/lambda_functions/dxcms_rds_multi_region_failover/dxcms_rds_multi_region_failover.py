...
def lambda_handler(event, context):
    try:
        ...
        secondary_DBSubnetGroupName="Feature-RDSInstanceMssql-Multi-Region-"+str(uuid4())
        secondary_DBSubnetGroupDescription="RDSInstanceMssql-Multi-Region"
        ...
        primary_nested_stack_logical_id="RDSInstanceMssql"
        try:
            ...
            if event["secondary"].lower()=="wait_rds_active":
                ...
                for db in db_instances:
                    ...
                    if db['DBInstanceIdentifier']==secondary_db_identifier.lower() and db['DBInstanceStatus'].lower()=="available":
                        ...
                        title="RDS-Mssql instance {} - Failover".format(db_identifier)
            ...
            if event["primary"].lower()=="wait_rds_active":
                ...
                for db in db_instances:
                    if db['DBInstanceIdentifier']==db_identifier.lower() and db['DBInstanceStatus'].lower()=="available":
                        ...
                        title="RDS-Mssql instance {} - Failback".format(secondary_db_identifier)
